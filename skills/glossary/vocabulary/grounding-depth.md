...
**Those items are the plan's ready LEAVES** (`skills/glossary/vocabulary/umbrella.md`), so the horizon is a
set of whole tracked issues and a **wave** is which of them run in parallel this cycle — a selection among
leaves, never a cut inside one.
