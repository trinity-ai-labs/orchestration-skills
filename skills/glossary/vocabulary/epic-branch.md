...
An **epic branch** is a convergence branch cut from the integration branch
(`skills/glossary/vocabulary/integration-branch.md`). An epic's slices fork from it
...
**An epic branch is not an umbrella (`skills/glossary/vocabulary/umbrella.md`), and having one settles nothing
about the other.** An umbrella is a
*tracking shape* — one issue holding a checklist of the remaining work, a fact about the tracker. An epic
branch
