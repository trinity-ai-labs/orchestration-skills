...
- Epic branch: yes — the W0 schema change leaves the branch half-migrated until Slices 2-4 land, and five slices fan out in parallel; slices fork from and PR into it
